...
def register(request):
    ...
    if request.method == 'POST':
        # Attempt to grab informatiom from the raw form information.
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # we set commit=False. This delays saving model
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return HttpResponse("Invalid login detalis supplied.")
    else:
